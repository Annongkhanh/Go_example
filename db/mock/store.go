...
// Source: github.com/Annongkhanh/Simple_bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) VerifyEmailTx(arg0 context.Context, arg1 db.UpdateVerifyEmailParams) (db.VerifyEmailTxResult, error) {
	m.ctrl.T.Helper()
